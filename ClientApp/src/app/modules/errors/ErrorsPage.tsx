...
const ErrorsPage: React.FC<React.PropsWithChildren> = () => {
        ...
        <div className='d-flex flex-column flex-column-fluid text-center p-10 py-lg-20'>
          ...
          <div className='pt-lg-10 mb-10'>
            <Routes>
              ...
              <Route path='/error/404' element={<Navigate to='/error/404' replace />} />
              <Route path='*' element={<Navigate to='/error/500' replace />} />
            </Routes>
