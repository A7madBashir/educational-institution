...
public interface IIdentityService
{
    ...
    Task<ApplicationUser> RegisterUserAsync(string phoneNumber, string role);
...
public class IdentityService(UserManager<ApplicationUser> userManager, IUserRepository repository)
    : IIdentityService
{
    ...
    public Task<ApplicationUser> RegisterUserAsync(string phoneNumber, string role)
    {
        throw new NotImplementedException();
    }
