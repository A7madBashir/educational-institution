...
using EducationalInstitution.Models.DTO.Responses;
using EducationalInstitution.Services.Repositories;
using EducationalInstitution.Mapper;

namespace EducationalInstitution.Handlers.DataTable;

public class DataTableHandler<TEntity, T>(IRepository<TEntity, T> repository, AppMapper mapper)
